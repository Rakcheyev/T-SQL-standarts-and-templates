<div style="text-align: center; font-size: 24px;">Оптимізація запитів SQL</div>
...
<div style="text-align: center; font-size: 24px;">JSON --- структурований формат обміну даними</div>
...
<div style="text-align: center; font-size: 24px;">Оператори JSON у PostgreSQL</div>
...
<div style="text-align: center; font-size: 24px;">Функція json_each</div>
...
<div style="text-align: center; font-size: 24px;">Функція json_each_text</div>
...
<div style="text-align: center; font-size: 24px;">Переваги використання JSON</div>
...
<div style="text-align: center; font-size: 24px;">Типи даних для зберігання дат і часу</div>
...
<div style="text-align: center; font-size: 24px;">Функції CURRENT_DATE і CURRENT_TIMESTAMP</div>
...
<div style="text-align: center; font-size: 24px;">Функції date and time type conversion</div>
...
<div style="text-align: center; font-size: 24px;">«YYYY-MM-DD».</div>
...
<div style="text-align: center; font-size: 24px;">Віконні функції (Window functions)</div>
...
<div style="text-align: center; font-size: 24px;">Порівняння агрегатних функцій з віконними функціями</div>
...
<div style="text-align: center; font-size: 24px;">Синтаксис віконних функцій PostgreSQL</div>
...
<div style="text-align: center; font-size: 24px;">Список віконних функцій PostgreSQL</div>
...
<div style="text-align: center; font-size: 24px;">Запит 3</div>
...
<div style="text-align: center; font-size: 24px;">Функції FIRST_VALUE і LAST_VALUE</div>
...
<div style="text-align: center; font-size: 24px;">Вираз RANGE BETWEEN UNBOUNDED PRECEDING AND UNBOUNDED FOLLOWING</div>
...
<div style="text-align: center; font-size: 24px;">Функції LAG і LEAD</div>
...
<div style="text-align: center; font-size: 24px;">Приклад використання функції LAG</div>
...
<div style="text-align: center; font-size: 24px;">Приклад використання функції LEAD</div>
...
<div style="text-align: center; font-size: 24px;">Найкращі практики написання та форматування коду</div>
...
<div style="text-align: center; font-size: 24px;">Хороший стиль</div>
...
<div style="text-align: center; font-size: 24px;">Поганий стиль</div>
...
<div style="text-align: center; font-size: 24px;">Умови найменування</div>
...
<div style="text-align: center; font-size: 24px;">Таблиці</div>
...
<div style="text-align: center; font-size: 24px;">Стовпці</div>
...
<div style="text-align: center; font-size: 24px;">Псевдонім або кореляції</div>
...
<div style="text-align: center; font-size: 24px;">Збережені процедури</div>
...
<div style="text-align: center; font-size: 24px;">Однорідні суфікси</div>
...
<div style="text-align: center; font-size: 24px;">Зарезервовані слова</div>
