...
<div style="text-align:  font-size: 24px;">Основна різниця між звичайними представленнями (views) і матеріалізованими представленнями (materialized views) в SQL:</div>
